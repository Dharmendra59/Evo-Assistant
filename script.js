...
function takeCommand(message) {
    ...
    if (message.includes('hello') || message.includes('hi') || message.includes('hay') || message.includes('hey')) {
        ...
        speak("I am Veronica, Virtual Assistant, created by Evolving Team member engineer Dharmendra Singh, How can i help you")
    } else if (message.includes('tum kon ho') || message.includes('hu r u')) {
        speak("Me Veronica hu, Virtual Assistant, Mujhe  Evolving Team member engineer Dharmendra Singh ke dvara bnaya gya hai, Kahiye me apki kaise madad kar sakti hu")
